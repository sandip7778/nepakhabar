                                    ...
                                    <div class="col-lg-4 col-md-12">
                                        <div class="col-lg-12 col-md-12">
                                            ...
                                            <label for="file-input">Choose Image</label>
                                                <input type="file" id="file-input" name="image" class="form-control"
                                                    value="{{ $post->path }}" onchange="preview()"  accept=".png, .jpeg, .jpg, ">
                                                @error('image')
                                                <span class="d-block mt-2 fs-6 text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="category"  multiple multiselect-search="true" multiselect-select-all="true" required>
                                                    @foreach ($categories as $category)
                                                    <option value="{{ $category->id }}"
                                                        {{ old('category',$category->name) == $post->category->name ? 'selected':'' }}>
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="trending_status" required>
                                                    ...
                                                    @for ($i=1;$i<=$trendingCount;$i++) <option value="{{ $i }}"
