                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="">
                            ...
                            <div class="card-body" id="add_pro_forom">
                                {{-- {{ dd($post->category) }} --}}
                                <form id="news_edit" method="post" action="{{ route('posts.update', $post->slug) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 col-md-12">
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="context" class="form-control"
                                                        value="{{ old('context', $post->context) }}"
                                            ...
                                            <div class="col-lg-12 col-md-12 mt-3">
                                                <div class="form-group">
                                                    <label>Post Description* (For advertisement write
                                                        {Advertisement})</label>
                                        ...
                                        <div class="col-lg-4 col-md-12">
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group add_product_img_box">
                                                    ...
                                                    <input type="file" id="file-input" name="image"
                                                        class="form-control" value="{{ $post->path }}"
                                                        onchange="preview()" accept=".png, .jpeg, .jpg, ">
                                                    @error('image')
                                                        <span class="d-block mt-2 fs-6 text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            @if ($post->path)
                                                <div class="col-lg-4 col-md-12">
                                                    ...
                                                    <img src="{{ Storage::url($post->path) }}"
                                                        alt="{{ $post->title . ' Image' }}" height="300" width="300">
                                                </div>
                                            @endif
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="url" name="youtube" class="form-control"
                                                        value="{{ old('youtube', $post->youtube) }}">
                                                    @error('youtube')
                                                        <span class="d-block mt-2 fs-6 text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="category_ids[]" size="4"
                                                        multiple multiselect-search="true" multiselect-select-all="true"
                                                        required>
                                                        @foreach ($categories as $category)
                                                            <option value="{{ $category->id }}"
                                                                {{ old('category_ids[]', $post->categories->contains($category->id)) ? 'selected' : '' }}>
                                            ...
                                            @if (Auth::user()->userType == 'admin')
                                                <div class="col-lg-12 col-md-12">
                                                    <div class="form-group">
                                                        <label class="f_text" for="exampleInputUsername1">Change
                                                            Author*</label>
                                                        <select class="form-control" name="user_id" required>
                                                            <option value="">Select</option>
                                                            @foreach ($users as $user)
                                                                <option value="{{ $user->id }}"
                                                                    {{ old('user_id', $user->id == $post->user->id) ? 'selected' : '' }}>
                                                                    {{ $user->name }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('user_id')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="trending_status" required>
                                                        ...
                                                        @for ($i = 1; $i <= $trendingCount; $i++)
                                                            <option value="{{ $i }}"
                                                                {{ old('trending_status', $post->trending_status) == $i ? 'selected' : '' }}>
                                                                {{ $i }}</option>
                                                        @endfor
                                                    </select>
                                        ...
                                        <div class="col-lg-4 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="meta_tag" class="form-control"
                                                    value="{{ old('meta_tag', $post->meta_tag) }}">
                                                @error('meta_tag')
                                                    <span class="d-block mt-2 fs-6 text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
