    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 posts-list">
                ...
                <div class="single-post pt-2">
                    <h1 class="h1f mb-5">{{ $post->title }}
                    </h1>
                    <div class="feature-img post_img_box">
                        <img class="img-fluid" src="{{ Storage::url($post->path) }}" style="width:100%"
                            alt="{{ $post->title }} Image" class="post_images">
                    </div>
                            ...
                            <div class="user justify-content-between d-flex flex-column">
                                ...
                                <div class="reply-btn hide">
                                    <form action="{{ route('posts.comments.store', $post->slug) }}" method="POST">
                                        ...
                                        <button type="submit" class="button btn_1 boxed-btn">Reply</button>
                                    </form>
